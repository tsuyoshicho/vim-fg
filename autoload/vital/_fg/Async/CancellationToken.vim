...
execute join(['function! vital#_fg#Async#CancellationToken#import() abort', printf("return map({'_vital_created': '', 'new': ''}, \"vital#_fg#function('<SNR>%s_' . v:key)\")", s:_SID()), 'endfunction'], "\n")
delfunction s:_SID
" ___vital___
let s:STATE_OPEN = 0
